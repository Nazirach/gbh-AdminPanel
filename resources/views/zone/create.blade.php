...
@section('scripts')
    <script>
        ...
        var enableOnlinePolygonMode = function() {
            console.warn('Online polygon mode is not ready yet.');
            return false;
        };
        var disableOnlinePolygonMode = function() {};
        var resetOnlinePolygonDrawing = function() {};
        var selectedShape;
        var selectedKernel;
        var gmarkers = [];
        var coordinates = [];
