# CUSTOMER ADD ADDRESS MINIMUM REQUIRED CHECK

Generated: 06/28/2026 20:04:01

Mode: fill minimum required address fields, then screen-check. No patch. No deploy. No Firebase manual write. No order creation.
...
clickable="true" enabled="true" focusable="true" focused="true" scrollable="false" long-clickable="false" password="false" 
selected="false" bounds="[45,1298][1035,1442]" /><node index="10" text="" resource-id="" class="android.view.View" 
...
bounds="[45,1487][396,1519]" /></node></node></node></node></node></node></node></node></node><node index="1" text="" 
...
- Area/Sector/Locality should contain exactly: Audit Area
- Nearby Landmark should remain empty.
- Home should be selected or tapped.
- Save Address should be visible, but not tapped yet.

## Final Status

STATUS: CUSTOMER_ADD_ADDRESS_MIN_REQUIRED_SCREEN_CHECKED