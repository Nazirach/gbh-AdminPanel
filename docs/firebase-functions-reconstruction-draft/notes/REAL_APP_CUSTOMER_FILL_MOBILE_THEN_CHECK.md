# CUSTOMER FILL MOBILE THEN CHECK

Generated: 06/28/2026 19:30:03
...
- Target field: Mobile Number
- Field bounds: [45,1287][1035,1431]
- Tap center: x=540 y=1360
- Input value: 8000000001

## Rule

- Fill only Mobile Number.
- Immediately capture XML and screenshot.
- Do not fill Password until mobile is confirmed exactly.

## Status

STATUS: CUSTOMER_FILL_MOBILE_STARTED

## Screen Check After Action

- XML dump: C:\deploy\adminpanel\docs\firebase-functions-reconstruction-draft\notes\customer_after_fill_mobile_dump.xml
- Screenshot: C:\deploy\adminpanel\docs\firebase-functions-reconstruction-draft\notes\customer_after_fill_mobile.png

```text

C:\deploy\adminpanel\docs\firebase-functions-reconstruction-draft\notes\customer_after_fill_mobile_dump.xml:1:<?xml version='1.0' 
...
STATUS: CUSTOMER_MOBILE_SCREEN_CHECKED_AFTER_INPUT